...
f.plot_and_save(
  ...
  filename='../svm_base/all_models_all_final_scores.png',
  x='model',
...
f.plot_and_save(
  ...
  filename='../svm_base/all_models_all_cv_test_scores.png',
  x='model',
...
f.plot_and_save(
  ...
  filename='../svm_base/all_models_all_cv_train_scores.png',
  x='model',
