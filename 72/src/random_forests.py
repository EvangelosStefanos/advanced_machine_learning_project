...
INFOFILE = '../logs/random_forests.csv'
...
metrics_y = ['accuracy', 'f1_micro', 'roc_auc', 'average_precision', 'label_ranking_average_precision_score']
...
f.plot_and_save(
  ...
  filename='../plots/random_forests/all_models_all_final_scores.png',
  x='model',
...
f.plot_and_save(
  ...
  filename='../plots/random_forests/all_models_all_cv_test_scores.png',
  x='model',
...
f.plot_and_save(
  ...
  filename='../plots/random_forests/all_models_all_cv_train_scores.png',
  x='model',
