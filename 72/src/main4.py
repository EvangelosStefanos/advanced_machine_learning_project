...
test_results_0 = test_results
best_results_0 = best_results
...
# plot test set accuracy and cv test accuracy for each of the 3 models
d = pd.DataFrame()
d['test_set_hamming_loss'] = list(test_results['hamming_loss'])
d['cv_test_hamming_loss'] = list(best_results['mean_test_hamming_loss'])
d['model'] = list(best_results['model'])
plot_and_save(d, '../test_cv_accuracy_3_svms.png', x='model')
...
# plot test set accuracy and cv test accuracy for each of the 3 models
d = pd.DataFrame()
d['cv_test_hamming_loss_6c'] = list(best_results_0['mean_test_hamming_loss'])
d['cv_test_hamming_loss_svms'] = list(best_results['mean_test_hamming_loss'])
d['model'] = list(best_results['model'])
plot_and_save(d, '../test_cv_accuracy_3_svms.png', x='model')
...
# plot test set accuracy and cv test accuracy for each of the 3 models
d = pd.DataFrame()
d['test_set_hamming_loss_6c'] = list(test_results_0['hamming_loss'])
d['test_set_hamming_loss_svms'] = list(test_results['hamming_loss'])
d['model'] = list(best_results['model'])
plot_and_save(d, '../test_cv_accuracy_3_svms.png', x='model')
